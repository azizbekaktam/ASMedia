...
export default function Navbar() {
  ...
  return (
    <nav className="bg-white dark:bg-gray-900 text-gray-900 dark:text-white px-4 sm:px-6 py-3 shadow-lg flex items-center justify-between">
      {/* Logo */}
      <div className="font-extrabold text-xl sm:text-2xl tracking-wide text-yellow-500">
      ...
      <div className="flex items-center gap-3 sm:gap-4">
        {/* Search bar */}
        <div className="w-24 sm:w-36 md:w-48 lg:w-64">
          <Search />
        </div>

        {/* Desktop Right */}
        <div className="hidden md:flex items-center gap-3">
          <div className="px-3 py-1 rounded-full bg-gradient-to-r from-yellow-400 to-yellow-500 text-black font-bold text-xs sm:text-sm shadow-md">
